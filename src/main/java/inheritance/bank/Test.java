...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Pobrałem "+ account.withdraw(20) + " zł pozostało "+ account.getCashAmount());
        System.out.println("Pobrałem "+ account.withdraw(10) + " zł pozostało "+ account.getCashAmount());
